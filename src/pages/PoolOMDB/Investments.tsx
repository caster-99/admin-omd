                ...
                <div className="mt-4">
                    ...
                    <div className="mt-8 flex items-center justify-between">
                        <p className="text-sm font-bold text-slate-500">
                            Mostrando {pagination.limit ? Math.min(pagination.limit * pagination.page, pagination.total) : investments.length} de {pagination.total} inversiones
                        </p>
                        <Pagination
                ...
                {selectedInv && (
                    <div className="flex flex-col">
                        ...
                        <div className="p-8 grid grid-cols-2 gap-y-8 gap-x-12">
                            ...
                            <DetailItem label="Balance Actual" value={`$${Number(selectedInv.balance || selectedInv.amount).toLocaleString()}`} />
                            ...
                            <DetailItem label="Inicio" value={selectedInv.startDate && new Date(selectedInv.startDate).toLocaleDateString()} />
